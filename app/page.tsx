...
function Particle({ i }: { i: number }) {
  return (
    <motion.div
      animate={{ y: [0, -50, 0], x: [0, i % 2 === 0 ? 25 : -25, 0], opacity: [0, 0.5, 0] }}
      transition={{ duration: 4 + i * 0.7, repeat: Infinity, delay: i * 0.6, ease: "easeInOut" }}
      className="absolute w-2 h-2 rounded-full bg-[#1579b7]/40"
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f0f6ff] text-[#0f172a] selection:bg-[#1579b7]/20 overflow-x-hidden">

      {/* ── Scroll Progress ── */}
      <motion.div
        className="fixed top-0 left-0 right-0 h-[3px] bg-gradient-to-r from-[#1579b7] to-[#5bb8f5] origin-left z-[100]"
        style={{ scaleX }}
      />

      {/* ══════════════ NAVIGATION ══════════════ */}
      <nav
        className="fixed top-0 w-full z-50 border-b border-[#1579b7]/10"
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          >
            <div className="relative w-32 h-20 transition-transform group-hover:scale-105">
              <Image src="/probilling.png" alt="Pro Billing Circle Logo" fill className="object-contain" priority />
            </div>
          </motion.div>
          ...
          <div className="hidden md:flex gap-8 text-sm font-semibold text-[#1579b7]">
            {["Services","Expertise","Specialties","Software","Contact"].map((item, i) => (
              <motion.a key={item}
                ...
                className="hover:text-[#0d5a8a] transition-colors relative group py-1 text-[#1579b7]"
              >
                {item}
          ...
          <div className="flex items-center gap-4">
            <motion.a
              whileHover={{ scale: 1.05, boxShadow: "0 0 25px rgba(21,121,183,0.35)" }}
              whileTap={{ scale: 0.95 }}
              href="#contact"
            ...
            <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="md:hidden text-[#1579b7]">
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div
              ...
              className="md:hidden border-t border-[#1579b7]/10 overflow-hidden bg-white"
            >
              <div className="px-6 py-4 flex flex-col gap-4">
                {["Services","Expertise","Specialties","Software","Contact"].map(item => (
                  <a key={item} href={`#${item.toLowerCase()}`} onClick={() => setMobileMenuOpen(false)}
                    className="text-[#1579b7] hover:text-[#0d5a8a] font-semibold py-2 border-b border-[#e2e8f0] transition-colors">
                    {item}
                  </a>
                ))}
      ...
      {/* ══════════════ HERO ══════════════ */}
      <section className="relative pt-40 pb-28 md:pt-52 md:pb-36 px-6 overflow-hidden bg-[#f0f6ff]">
        {/* BG layers */}
        <div className="absolute inset-0 -z-10">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,#1579b720,transparent)]" />
          <div className="absolute inset-0 bg-[linear-gradient(#1579b710_1px,transparent_1px),linear-gradient(to_right,#1579b710_1px,transparent_1px)] bg-[size:48px_48px]" />
        </div>
        <motion.div animate={{ scale:[1,1.3,1], opacity:[0.07,0.14,0.07] }} transition={{ duration:8, repeat:Infinity, ease:"easeInOut" }}
        ...
        <motion.div animate={{ scale:[1,1.2,1], opacity:[0.05,0.1,0.05] }} transition={{ duration:10, repeat:Infinity, ease:"easeInOut", delay:3 }}
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center relative z-10">
          ...
          <div>
            ...
            <div className="mb-8 overflow-hidden">
              <svg viewBox="0 0 300 40" className="w-52 h-8 opacity-40">
            ...
            <motion.h1 initial={{ opacity:0, y:40 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.8, delay:0.2 }}
              className="text-4xl md:text-6xl font-black text-[#0f172a] leading-[1.1] mb-6 tracking-tight">
              Intelligent{" "}
            ...
            <motion.div initial={{ opacity:0, y:30 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.8, delay:0.5 }}
              ...
              <motion.a whileHover={{ scale:1.05, boxShadow:"0 0 40px rgba(21,121,183,0.4)" }}
                ...
                <span className="relative z-10 flex items-center gap-2">
                  Start Billing Smarter <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                </span>
              </motion.a>
              <motion.a whileHover={{ scale:1.05 }} whileTap={{ scale:0.95 }} href="#services"
                className="px-8 py-4 rounded-full border-2 border-[#1579b7]/30 text-[#1579b7] font-bold hover:bg-[#1579b7]/10 transition-all">
                View Services
              </motion.a>
            </motion.div>
            ...
            <motion.div initial={{ opacity:0 }} animate={{ opacity:1 }} transition={{ delay:1.1, duration:0.8 }}
              className="flex items-center gap-8 mt-10 pt-10 border-t border-[#e2e8f0]">
              {[{ val:"98%", label:"Satisfaction" },{ val:"100+", label:"Practices" }].map(item => (
                <div key={item.label} className="text-center">
                  ...
                  <div className="text-[10px] uppercase tracking-widest text-[#94a3b8] font-semibold mt-0.5">{item.label}</div>
                </div>
              ))}
            </motion.div>
          </div>
          ...
          <motion.div initial={{ opacity:0, x:60 }} animate={{ opacity:1, x:0 }} transition={{ duration:1, delay:0.3 }} className="relative">
            ...
            <motion.div animate={{ y:[0,-16,0] }} transition={{ duration:6, repeat:Infinity, ease:"easeInOut" }}
              className="relative rounded-3xl overflow-hidden border border-[#bfdbfe]"
              style={{ background:"linear-gradient(145deg,#fff 0%,#f0f6ff 50%,#dbeafe 100%)", boxShadow:"0 20px 60px rgba(21,121,183,0.12)" }}>
              <motion.div animate={{ x:["-100%","200%"] }} transition={{ duration:3.5, repeat:Infinity, repeatDelay:2, ease:"easeInOut" }}
                className="absolute inset-0 bg-gradient-to-r from-transparent via-white/40 to-transparent skew-x-12 pointer-events-none" />
              <div className="p-10">
                <div className="flex items-center justify-between mb-8">
                  <div>
                    <div className="text-[10px] uppercase tracking-[0.25em] text-[#94a3b8] font-bold mb-1">Revenue Dashboard</div>
                    <h3 className="text-xl font-black text-[#0f172a]">Monthly Performance</h3>
                  </div>
                  <motion.div animate={{ scale:[1,1.2,1] }} transition={{ duration:2, repeat:Infinity }}
                    className="w-11 h-11 rounded-full bg-[#1579b7]/15 flex items-center justify-center">
                ...
                <div className="space-y-6">
                  {[
                    { label:"Claims Processed",    value:95, colorFrom:"#1579b7", colorTo:"#5bb8f5", delay:0   },
                    { label:"Reimbursement Rate",  value:10, colorFrom:"#0d5a8a", colorTo:"#1579b7", delay:0.3 },
                    { label:"Denial Reduction",    value:72, colorFrom:"#93c5fd", colorTo:"#1579b7", delay:0.6 },
                  ].map(bar => (
                    <div key={bar.label}>
                      <div className="flex justify-between text-sm mb-2">
                        <span className="text-[#64748b] font-medium">{bar.label}</span>
                        <motion.span initial={{ opacity:0 }} animate={{ opacity:1 }} transition={{ delay:bar.delay+1.2 }}
                          className="text-[#0f172a] font-bold">{bar.value}%</motion.span>
                      </div>
                      <div className="h-2.5 bg-[#dbeafe] rounded-full overflow-hidden">
                        <motion.div initial={{ width:0 }} animate={{ width:`${bar.value}%` }}
                          ...
                          <motion.div animate={{ opacity:[0,1,0] }} transition={{ duration:1.5, repeat:Infinity, delay:bar.delay }}
                            className="absolute right-0 top-0 h-full w-5 bg-white/60 rounded-full blur-sm" />
                        </motion.div>
                      </div>
                    </div>
                  ))}
                ...
                <div className="mt-8 pt-6 border-t border-[#e2e8f0] grid grid-cols-3 gap-2 text-center">
                  {[{ label:"Turnaround",value:"24h" },{ label:"First-Pass",value:"96%" },{ label:"Clients",value:"100+" }].map(s => (
                    <div key={s.label}>
                      ...
                      <div className="text-[9px] text-[#94a3b8] uppercase tracking-wider font-bold mt-0.5">{s.label}</div>
                    </div>
                  ))}
                </div>
              </div>
      ...
      {/* ══════════════ STATS STRIP ══════════════ */}
      <section className="py-20 relative overflow-hidden" style={{ background:"linear-gradient(135deg,#1d4ed8 0%,#1579b7 100%)" }}>
            ...
            <motion.div variants={cardVariant} key={stat.label} className="flex flex-col items-center text-center group">
              <div className="relative mb-5">
                ...
                <motion.div animate={{ rotate:360 }} transition={{ duration:12, repeat:Infinity, ease:"linear" }}
                  ...
                  style={{ background:"conic-gradient(from 0deg,rgba(255,255,255,0.6),transparent 50%,rgba(255,255,255,0.6) 80%,transparent)" }} />
                <motion.div whileHover={{ scale:1.1 }}
                  className="relative z-10 w-14 h-14 rounded-full flex items-center justify-center bg-white/20 border border-white/30">
                  {stat.icon}
                </motion.div>
              </div>
              <div className="text-4xl md:text-5xl font-black mb-1 tabular-nums text-white" style={{ textShadow:"0 0 30px rgba(255,255,255,0.3)" }}>
                <CountUp target={stat.numericValue} suffix={stat.suffix} />
              </div>
              <motion.div initial={{ scaleX:0 }} whileInView={{ scaleX:1 }} viewport={{ once:true }}
                transition={{ delay:0.6+i*0.15, duration:0.5 }}
                className="w-8 h-0.5 bg-white/60 my-2 origin-left rounded-full" />
              <div className="text-[11px] uppercase tracking-[0.2em] text-white/70 font-bold">{stat.label}</div>
            </motion.div>
          ))}
        </motion.div>
      </section>
      ...
      <section className="py-24 px-6 bg-white relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_40%_at_50%_50%,#1579b708,transparent)]" />
        <div className="max-w-7xl mx-auto relative z-10">
          <motion.div {...fadeInUp} className="text-center mb-16">
            ...
            <h3 className="text-4xl md:text-5xl font-black text-[#0f172a]">
              Built Different.<br />
          ...
          <motion.div variants={staggerContainer} initial="initial" whileInView="whileInView" viewport={{ once:true }}
            ...
            {whyUs.map((item,i) => (
              <motion.div variants={cardVariant} key={item.title}
                whileHover={{ y:-8, borderColor:"rgba(21,121,183,0.4)", boxShadow:"0 16px 40px rgba(21,121,183,0.12)" }}
                className="p-8 rounded-2xl border border-[#e2e8f0] relative overflow-hidden group transition-all duration-300 bg-[#f8faff]">
                <motion.div animate={{ opacity:[0,0.06,0] }} transition={{ duration:3, repeat:Infinity, delay:i*0.5 }}
                  className="absolute inset-0 bg-[#1579b7] rounded-2xl" />
                <div className="w-12 h-12 rounded-xl bg-[#1579b7]/10 flex items-center justify-center text-[#1579b7] mb-5
                  group-hover:bg-[#1579b7] group-hover:text-white transition-all duration-300 relative z-10">
                  {item.icon}
                </div>
                <h4 className="text-lg font-black text-[#0f172a] mb-2 relative z-10">{item.title}</h4>
      ...
      {/* ══════════════ SERVICES ══════════════ */}
      <section id="services" className="py-24 md:py-32 px-6 relative overflow-hidden bg-[#f0f6ff]">
        <div className="absolute inset-0 bg-[linear-gradient(#1579b708_1px,transparent_1px),linear-gradient(to_right,#1579b708_1px,transparent_1px)] bg-[size:40px_40px]" />
        <div className="max-w-7xl mx-auto relative z-10">
          <motion.div {...fadeInUp} className="text-center mb-20">
            <span className="text-[#1579b7] font-bold uppercase tracking-widest text-xs mb-4 block">Core Solutions</span>
            <h3 className="text-4xl md:text-5xl font-black text-[#0f172a]">Complete RCM Services</h3>
          </motion.div>
          <motion.div variants={staggerContainer} initial="initial" whileInView="whileInView" viewport={{ once:true }}
            className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service,i) => (
              <motion.div variants={cardVariant} key={service.title} whileHover={{ y:-10, boxShadow:"0 20px 48px rgba(21,121,183,0.13)" }}
                className="p-8 rounded-2xl border border-[#dbeafe] group relative overflow-hidden transition-all duration-300 cursor-default bg-white">
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                  style={{ background:"linear-gradient(145deg,rgba(21,121,183,0.05),transparent)" }} />
                ...
                <div className="w-12 h-12 rounded-xl bg-[#1579b7]/10 flex items-center justify-center text-[#1579b7] mb-6
                  group-hover:bg-[#1579b7] group-hover:text-white transition-all duration-300 relative z-10">
                  {service.icon}
                </div>
                <h4 className="text-lg font-black text-[#0f172a] mb-3 relative z-10">{service.title}</h4>
                <p className="text-[#64748b] text-sm leading-relaxed relative z-10">{service.description}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      {/* ══════════════ EXPERTISE ══════════════ */}
      <section id="expertise" className="py-24 px-6 relative overflow-hidden bg-white">
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeInUp}>
              <span className="text-[#1579b7] font-bold uppercase tracking-widest text-xs mb-4 block">Our Expertise</span>
              <h3 className="text-4xl font-black text-[#0f172a] mb-8 leading-tight">Specialized Coding<br />&amp; Compliance</h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                {codingExpertise.map((item,idx) => (
                  <motion.div initial={{ opacity:0, x:-20 }} whileInView={{ opacity:1, x:0 }}
                    ...
                    whileHover={{ x:5, boxShadow:"0 8px 24px rgba(21,121,183,0.12)" }}
                    className="p-5 rounded-xl border border-[#dbeafe] hover:border-[#1579b7]/40 transition-all group bg-[#f8faff]">
                    ...
                    <div className="text-xs text-[#64748b] font-semibold">{item.desc}</div>
                  </motion.div>
                ))}
              </div>
            </motion.div>
            ...
            <motion.div initial={{ opacity:0, scale:0.95 }} whileInView={{ opacity:1, scale:1 }} viewport={{ once:true }}
              className="rounded-3xl p-10 relative overflow-hidden border border-[#bfdbfe]"
              style={{ background:"linear-gradient(145deg,#eff6ff,#dbeafe)", boxShadow:"0 16px 48px rgba(21,121,183,0.1)" }}>
              ...
              <h4 className="text-2xl font-black mb-8 relative z-10 text-[#0f172a]">Insurance Portals Managed</h4>
              <div className="space-y-5 relative z-10">
                {portals.map((portal,idx) => (
                  <motion.div initial={{ opacity:0, x:30 }} whileInView={{ opacity:1, x:0 }}
                    ...
                    <div className="w-9 h-9 rounded-full bg-[#1579b7]/15 flex items-center justify-center shrink-0 group-hover:bg-[#1579b7]/30 transition-colors">
                      <CheckCircle2 className="text-[#1579b7] w-5 h-5" />
                    </div>
                    <span className="text-lg font-semibold text-[#1e3a8a] group-hover:text-[#1579b7] transition-colors">{portal}</span>
                  </motion.div>
                ))}
              </div>
            </motion.div>
      ...
      {/* ══════════════ CEO / LEADERSHIP ══════════════ */}
      <section id="ceo" className="py-24 px-6 relative overflow-hidden bg-[#f0f6ff]">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_50%_60%_at_30%_50%,#1579b710,transparent)]" />
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity:0, scale:0.95 }} whileInView={{ opacity:1, scale:1 }}
              ...
              <div className="relative group">
                <motion.div animate={{ rotate:360 }} transition={{ duration:20, repeat:Infinity, ease:"linear" }}
                  ...
                  style={{ background:"conic-gradient(from 0deg,#1579b7,transparent 40%,#1579b7 70%,transparent)" }} />
                <div className="absolute inset-0 bg-[#1579b7]/10 rounded-3xl blur-2xl group-hover:bg-[#1579b7]/20 transition-all duration-700" />
                <video src="/pro.mp4" autoPlay loop muted playsInline
                  className="relative w-full max-w-sm h-auto object-cover rounded-3xl shadow-2xl border border-[#bfdbfe]" />
              </div>
            </motion.div>
            ...
            <motion.div initial={{ opacity:0, x:30 }} whileInView={{ opacity:1, x:0 }}
              ...
              <p className="text-[#64748b] text-lg leading-relaxed mb-6">
                As the Founder &amp; Growth Strategist of <strong className="text-[#0f172a]">ProBilling Circle</strong>,
                I lead the company's vision and expansion by developing scalable strategies that drive revenue, optimize operations, and ensure long-term business growth.
              </p>
      ...
      {/* ══════════════ TESTIMONIALS ══════════════ */}
      <section className="py-24 px-6 relative overflow-hidden" style={{ background:"linear-gradient(135deg,#1d4ed8 0%,#1579b7 100%)" }}>
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <motion.div {...fadeInUp} className="text-center mb-16">
            <span className="text-white/70 font-bold uppercase tracking-widest text-xs mb-4 block">Client Stories</span>
          ...
          <div className="relative min-h-[220px]">
            <AnimatePresence mode="wait">
              <motion.div key={activeTestimonial}
                ...
                className="p-10 rounded-3xl border border-white/20 relative"
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-white/30 flex items-center justify-center text-white font-black text-lg">
          ...
          <div className="flex justify-center gap-3 mt-8">
            {testimonials.map((_,i) => (
              <button key={i} onClick={() => setActiveTestimonial(i)}
                className={`h-2.5 rounded-full transition-all duration-300 ${i===activeTestimonial ? "bg-white w-8" : "w-2.5 bg-white/30 hover:bg-white/50"}`} />
            ))}
          </div>
        </div>
      </section>
      ...
      <section id="software" className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-20">
            <motion.div {...fadeInUp}>
              <div className="flex items-center gap-3 mb-10">
                <div className="w-10 h-10 rounded-xl bg-[#1579b7]/15 flex items-center justify-center text-[#1579b7]">
                  <Laptop className="w-5 h-5" />
                </div>
                <h3 className="text-3xl font-black text-[#0f172a]">Software Experience</h3>
              </div>
              <div className="flex flex-wrap gap-3">
                {software.map((sw,idx) => (
                  <motion.span initial={{ opacity:0, scale:0.8 }} whileInView={{ opacity:1, scale:1 }}
                    ...
                    className="px-5 py-2.5 rounded-full border border-[#dbeafe] text-[#1e3a8a] font-bold text-sm cursor-default transition-all duration-200 hover:bg-[#1579b7]/10 bg-[#f8faff]">
                    {sw}
                  </motion.span>
                ))}
              </div>
            ...
            <motion.div id="specialties" {...fadeInUp}>
              <div className="flex items-center gap-3 mb-10">
                ...
                <h3 className="text-3xl font-black text-[#0f172a]">Supported Specialties</h3>
              </div>
              <div className="grid grid-cols-2 gap-3">
                {specialties.map((spec,idx) => (
                  <motion.div initial={{ opacity:0, y:10 }} whileInView={{ opacity:1, y:0 }}
                    ...
                    whileHover={{ x:5 }}
                    className="flex items-center gap-3 p-4 rounded-xl border border-[#dbeafe] hover:border-[#1579b7]/40 transition-all group bg-[#f8faff]">
                    ...
                    <span className="font-semibold text-[#1e3a8a] group-hover:text-[#1579b7] transition-colors text-sm">{spec}</span>
                  </motion.div>
                ))}
              </div>
            </motion.div>
      ...
      {/* ══════════════ ONBOARDING ══════════════ */}
      <section className="py-24 px-6 relative overflow-hidden" style={{ background:"linear-gradient(135deg,#1579b7 0%,#1d4ed8 100%)" }}>
        <div className="absolute inset-0 opacity-10">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <motion.div {...fadeInUp}>
            <span className="text-white/70 font-bold uppercase tracking-widest text-xs mb-4 block">Process</span>
            <h3 className="text-4xl md:text-5xl font-black text-white mb-6">Seamless Client Onboarding</h3>
            <p className="text-xl mb-16 text-white/85 leading-relaxed max-w-2xl mx-auto">
          ...
          <motion.div variants={staggerContainer} initial="initial" whileInView="whileInView" viewport={{ once:true }}
            ...
            {[
              ...
              <motion.div variants={cardVariant} key={step.title}
                whileHover={{ y:-6, background:"rgba(255,255,255,0.25)" }}
                className="bg-white/15 backdrop-blur-md p-8 rounded-2xl border border-white/25 transition-all duration-300">
                <div className="flex items-center gap-3 mb-4">
                  <div className="text-4xl font-black text-white/20">0{i+1}</div>
                  <div className="w-10 h-10 rounded-xl bg-white/25 flex items-center justify-center text-white">{step.icon}</div>
                </div>
      ...
      {/* ══════════════ CONTACT ══════════════ */}
      <section id="contact" className="py-24 md:py-32 px-6 bg-[#f0f6ff]">
        <div className="max-w-5xl mx-auto">
          ...
          <motion.div initial={{ opacity:0, y:50 }} whileInView={{ opacity:1, y:0 }}
            ...
            className="rounded-3xl overflow-hidden border border-[#bfdbfe] flex flex-col md:flex-row"
            style={{ background:"#fff", boxShadow:"0 20px 60px rgba(21,121,183,0.1)" }}>

            {/* Left info */}
            <div className="flex-1 p-10 md:p-12 border-b md:border-b-0 md:border-r border-[#e2e8f0] bg-[#f8faff]">
              <h4 className="text-2xl font-black text-[#0f172a] mb-3">Ready to get started?</h4>
              ...
              <div className="space-y-6">
                {[
                  ...
                  { icon:<Globe className="w-5 h-5" />, label:"Location",          value:"Michigan, United States of America",        link:null },
                  ...
                  <motion.div whileHover={{ x:6 }} key={idx} className="flex items-center gap-4 group">
                    <a href={item.link || "#"} target={item.link?.startsWith("http") ? "_blank" : undefined}
                      ...
                      className="w-11 h-11 rounded-full bg-[#1579b7]/12 flex items-center justify-center text-[#1579b7] group-hover:bg-[#1579b7] group-hover:text-white transition-all shrink-0">
                      {item.icon}
                    </a>
                    <div>
                      <div className="text-[10px] font-bold text-[#94a3b8] uppercase tracking-widest">{item.label}</div>
                      <div className="font-bold text-[#1e3a8a] group-hover:text-[#1579b7] transition-colors text-sm">{item.value}</div>
                    </div>
                  </motion.div>
                ))}
              </div>
              ...
              <form className="space-y-4">
                {[
                  ...
                  <input key={field.placeholder} type={field.type} placeholder={field.placeholder}
                    className="w-full px-5 py-4 rounded-xl border border-[#dbeafe] bg-[#f8faff] text-[#0f172a] placeholder-[#94a3b8] focus:border-[#1579b7] focus:bg-white outline-none transition-all text-sm font-medium" />
                ))}
                <textarea placeholder="Tell us about your billing challenges..." rows={4}
                  className="w-full px-5 py-4 rounded-xl border border-[#dbeafe] bg-[#f8faff] text-[#0f172a] placeholder-[#94a3b8] focus:border-[#1579b7] outline-none transition-all resize-none text-sm font-medium" />
                <motion.button type="button"
                  whileHover={{ scale:1.02, boxShadow:"0 0 30px rgba(21,121,183,0.35)" }}
                  whileTap={{ scale:0.98 }}
      ...
      {/* ══════════════ FOOTER ══════════════ */}
      <footer className="py-12 border-t border-[#e2e8f0] px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-8">
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm font-semibold text-[#94a3b8]">
              {["Services","Expertise","Specialties","Software","Contact"].map(item => (
                <a key={item} href={`#${item.toLowerCase()}`} className="hover:text-[#1579b7] transition-colors">{item}</a>
              ))}
            </div>
            <div className="flex gap-6 text-sm font-semibold text-[#94a3b8]">
          ...
          <div className="border-t border-[#e2e8f0] pt-8 text-center text-xs text-[#94a3b8] font-semibold">
